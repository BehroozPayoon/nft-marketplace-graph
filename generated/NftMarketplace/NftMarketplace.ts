...
export class NftMarketplace__getMarketItemResultValue0Struct extends ethereum.Tuple {
  get seller(): Address {
...
export class NftMarketplace extends ethereum.SmartContract {
  ...
  getAddressProceeds(seller: Address): BigInt {
    let result = super.call(
      "getAddressProceeds",
      "getAddressProceeds(address):(uint256)",
  ...
  try_getAddressProceeds(seller: Address): ethereum.CallResult<BigInt> {
  ...
  getMarketItem(
    nftAddress: Address,
    tokenId: BigInt
  ): NftMarketplace__getMarketItemResultValue0Struct {
    let result = super.call(
      "getMarketItem",
      "getMarketItem(address,uint256):((address,uint256))",
      [
    ...
    return changetype<NftMarketplace__getMarketItemResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getMarketItem(
    nftAddress: Address,
    tokenId: BigInt
  ): ethereum.CallResult<NftMarketplace__getMarketItemResultValue0Struct> {
    let result = super.tryCall(
      "getMarketItem",
      "getMarketItem(address,uint256):((address,uint256))",
      [
    ...
    return ethereum.CallResult.fromValue(
      changetype<NftMarketplace__getMarketItemResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
